...
typedef RT_MODEL_Motor_System_ID_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Motor_System_ID(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Motor_System_ID_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Motor_System_ID -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
