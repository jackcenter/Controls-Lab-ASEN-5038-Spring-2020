...
MODEL                = USE_THIS_Closed_Loop_Motor_System_ID
MODULES              = USE_THIS_Closed_Loop_Motor_System_ID_data.c USE_THIS_Closed_Loop_Motor_System_ID_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_sim.c
MAKEFILE             = USE_THIS_Closed_Loop_Motor_System_ID.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\Users\QuarcUser\Documents\ECEN_5038_MJ\Controls-Lab-ECEN-5038-Spring-2020\Joint_Module
...
NCSTATES             = 0
COMPUTER             = PCWIN64
BUILDARGS            =  EXT_MODE=1 EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 SHOW_TIMES=0 DEBUG=0 DEBUG_HEAP=0 INCLUDE_MDL_TERMINATE_FCN=1 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
MULTITASKING         = 0
RELEASE_VERSION      = R2019a
MAT_FILE             = 0
...
MODELLIB                  = USE_THIS_Closed_Loop_Motor_System_IDlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = USE_THIS_Closed_Loop_Motor_System_ID_ref.rsp

COMPILER_COMMAND_FILE     = USE_THIS_Closed_Loop_Motor_System_ID_comp.rsp
...
SRCS = $(MODEL).$(TARGET_LANG_EXT) $(MODULES) $(USER_SRCS)
...
# Set QUARC libraries
QUARC_LIBS = extmode_quarc_r2013b.lib quanser_communications.lib quanser_runtime.lib quanser_common.lib ippcvmt.lib ippimt.lib ippsmt.lib ippvmmt.lib ippcoremt.lib shell32.lib
