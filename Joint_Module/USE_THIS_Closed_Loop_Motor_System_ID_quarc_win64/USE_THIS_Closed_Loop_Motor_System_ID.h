/*
 * USE_THIS_Closed_Loop_Motor_System_ID.h
 *
...
#ifndef RTW_HEADER_USE_THIS_Closed_Loop_Motor_System_ID_h_
#define RTW_HEADER_USE_THIS_Closed_Loop_Motor_System_ID_h_
#include <math.h>
#include <string.h>
#ifndef USE_THIS_Closed_Loop_Motor_System_ID_COMMON_INCLUDES_
# define USE_THIS_Closed_Loop_Motor_System_ID_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif               /* USE_THIS_Closed_Loop_Motor_System_ID_COMMON_INCLUDES_ */

#include "USE_THIS_Closed_Loop_Motor_System_ID_types.h"
...
#define USE_THIS_Closed_Loop_Motor_System_ID_rtModel RT_MODEL_USE_THIS_Closed_Loop_T
...
typedef struct {
  ...
  real_T Sum;                          /* '<Root>/Sum' */
  real_T MotorDir;                     /* '<S1>/Motor Dir ' */
  real_T Clock;                        /* '<Root>/Clock' */
} B_USE_THIS_Closed_Loop_Motor__T;
...
typedef struct {
  ...
  int32_T HILReadEncoder_Buffer[2];    /* '<S1>/HIL Read Encoder' */
} DW_USE_THIS_Closed_Loop_Motor_T;
...
typedef struct {
   ...
   */
  real_T SineWave_rtw_collapsed_sub_expr[250];
} ConstP_USE_THIS_Closed_Loop_M_T;

/* Backward compatible GRT Identifiers */
#define rtB                            USE_THIS_Closed_Loop_Motor_Sy_B
#define BlockIO                        B_USE_THIS_Closed_Loop_Motor__T
#define rtP                            USE_THIS_Closed_Loop_Motor_Sy_P
#define Parameters                     P_USE_THIS_Closed_Loop_Motor__T
#define rtDWork                        USE_THIS_Closed_Loop_Motor_S_DW
#define D_Work                         DW_USE_THIS_Closed_Loop_Motor_T
#define ConstParam                     ConstP_USE_THIS_Closed_Loop_M_T
#define rtcP                           USE_THIS_Closed_Loop_Mot_ConstP

/* Parameters (default storage) */
struct P_USE_THIS_Closed_Loop_Motor__T_ {
  real_T T;                            /* Variable: T
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T a;                            /* Variable: a
  ...
  real_T ServoCountstoRad_Gain;        /* Expression: 2*pi/4096
                                        ...
                                        */
  real_T ServoCountstoRad1_Gain;       /* Expression: 2*pi/4096
                                        * Referenced by: '<S1>/Servo:  Counts to Rad1'
                                        */
  real_T TachDir_Gain;                 /* Expression: -1
                                        * Referenced by: '<S1>/Tach Dir'
                                        */
  real_T SineWave_Bias;                /* Expression: 0
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T SineWave_Phase[250];          /* Expression: 2*pi*rand(1,N)
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
...
struct tag_RTM_USE_THIS_Closed_Loop__T {
  const char_T *path;
...
extern P_USE_THIS_Closed_Loop_Motor__T USE_THIS_Closed_Loop_Motor_Sy_P;

/* Block signals (default storage) */
extern B_USE_THIS_Closed_Loop_Motor__T USE_THIS_Closed_Loop_Motor_Sy_B;

/* Block states (default storage) */
extern DW_USE_THIS_Closed_Loop_Motor_T USE_THIS_Closed_Loop_Motor_S_DW;

/* Constant parameters (default storage) */
extern const ConstP_USE_THIS_Closed_Loop_M_T USE_THIS_Closed_Loop_Mot_ConstP;

/* Model entry point functions */
extern void USE_THIS_Closed_Loop_Motor_System_ID_initialize(void);
extern void USE_THIS_Closed_Loop_Motor_System_ID_output(void);
extern void USE_THIS_Closed_Loop_Motor_System_ID_update(void);
extern void USE_THIS_Closed_Loop_Motor_System_ID_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern USE_THIS_Closed_Loop_Motor_System_ID_rtModel
  *USE_THIS_Closed_Loop_Motor_System_ID(void);
...
extern RT_MODEL_USE_THIS_Closed_Loop_T *const USE_THIS_Closed_Loop_Motor_S_M;
 ...
 *
 * '<Root>' : 'USE_THIS_Closed_Loop_Motor_System_ID'
 * '<S1>'   : 'USE_THIS_Closed_Loop_Motor_System_ID/Motor'
 */
#endif                  /* RTW_HEADER_USE_THIS_Closed_Loop_Motor_System_ID_h_ */
