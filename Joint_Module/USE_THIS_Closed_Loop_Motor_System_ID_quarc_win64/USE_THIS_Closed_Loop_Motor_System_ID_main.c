/****************************************************************************
 * USE_THIS_Closed_Loop_Motor_System_ID_main.c
 *
 * This file was generated automatically by QUARC. It serves as the main
 * entry point for the real-time code.
 *
 * Date:           Thu Mar  5 17:27:46 2020
 * Model version:  1.232
 * Matlab version: 9.1 (R2019a) 23-Nov-2018
 ****************************************************************************/
...
typedef RT_MODEL_USE_THIS_Closed_Loop_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * USE_THIS_Closed_Loop_Motor_System_ID(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(USE_THIS_Closed_Loop_Motor_S_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://USE_THIS_Closed_Loop_Motor_System_ID:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: USE_THIS_Closed_Loop_Motor_System_ID -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = USE_THIS_Closed_Loop_Motor_System_ID();
  if (rtmGetErrorStatus(S) != NULL) {
