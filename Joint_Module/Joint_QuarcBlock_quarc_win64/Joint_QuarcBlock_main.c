...
typedef RT_MODEL_Joint_QuarcBlock_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Joint_QuarcBlock(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Joint_QuarcBlock_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Joint_QuarcBlock -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
