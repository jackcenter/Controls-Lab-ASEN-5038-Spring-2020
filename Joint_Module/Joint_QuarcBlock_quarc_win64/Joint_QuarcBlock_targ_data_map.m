  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (Joint_QuarcBlock_P)
    ;%
      section.nData     = 2;
      section.data(2)  = dumData; %prealloc
      
	  ;% Joint_QuarcBlock_P.A
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Joint_QuarcBlock_P.T
	  ...
	  ;% Joint_QuarcBlock_P.HILWrite_analog_channels
	  section.data(1).logicalSrcIdx = 2;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Joint_QuarcBlock_P.HILReadEncoder_channels
	  section.data(2).logicalSrcIdx = 3;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Joint_QuarcBlock_P.HILReadAnalog_channels
	  section.data(3).logicalSrcIdx = 4;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Joint_QuarcBlock_P.HILReadEncoder1_channels
	  ...
	  ;% Joint_QuarcBlock_P.HILInitialize_OOTerminate
	  section.data(1).logicalSrcIdx = 6;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_OOExit
	  section.data(2).logicalSrcIdx = 7;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_OOStart
	  section.data(3).logicalSrcIdx = 8;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_OOEnter
	  ...
	  ;% Joint_QuarcBlock_P.HILInitialize_POFinal
	  ...
	  ;% Joint_QuarcBlock_P.HILInitialize_POFrequency
	  section.data(13).logicalSrcIdx = 18;
	  section.data(13).dtTransOffset = 12;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POInitial
	  section.data(14).logicalSrcIdx = 19;
	  section.data(14).dtTransOffset = 13;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POWatchdog
	  section.data(15).logicalSrcIdx = 20;
	  section.data(15).dtTransOffset = 14;
	
	  ;% Joint_QuarcBlock_P.ServoCountstoRad_Gain
	  section.data(16).logicalSrcIdx = 21;
	  section.data(16).dtTransOffset = 15;
	
	  ;% Joint_QuarcBlock_P.TachDir_Gain
	  section.data(17).logicalSrcIdx = 22;
	  section.data(17).dtTransOffset = 16;
	
	  ;% Joint_QuarcBlock_P.ServoCountstoRad1_Gain
	  ...
	  ;% Joint_QuarcBlock_P.SineWave_Hsin
	  ...
	  ;% Joint_QuarcBlock_P.HILInitialize_CKChannels
	  section.data(1).logicalSrcIdx = 32;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOWatchdog
	  ...
	  ;% Joint_QuarcBlock_P.HILInitialize_POModes
	  ...
	  ;% Joint_QuarcBlock_P.HILInitialize_AIChannels
	  section.data(1).logicalSrcIdx = 36;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AOChannels
	  section.data(2).logicalSrcIdx = 37;
	  section.data(2).dtTransOffset = 2;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_EIChannels
	  ...
	  ;% Joint_QuarcBlock_P.HILInitialize_Active
	  section.data(1).logicalSrcIdx = 40;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AOTerminate
	  section.data(2).logicalSrcIdx = 41;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AOExit
	  section.data(3).logicalSrcIdx = 42;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOTerminate
	  section.data(4).logicalSrcIdx = 43;
	  section.data(4).dtTransOffset = 3;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOExit
	  section.data(5).logicalSrcIdx = 44;
	  section.data(5).dtTransOffset = 4;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POTerminate
	  section.data(6).logicalSrcIdx = 45;
	  section.data(6).dtTransOffset = 5;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POExit
	  section.data(7).logicalSrcIdx = 46;
	  section.data(7).dtTransOffset = 6;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_CKPStart
	  section.data(8).logicalSrcIdx = 47;
	  section.data(8).dtTransOffset = 7;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_CKPEnter
	  section.data(9).logicalSrcIdx = 48;
	  section.data(9).dtTransOffset = 8;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_CKStart
	  section.data(10).logicalSrcIdx = 49;
	  section.data(10).dtTransOffset = 9;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_CKEnter
	  section.data(11).logicalSrcIdx = 50;
	  section.data(11).dtTransOffset = 10;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AIPStart
	  section.data(12).logicalSrcIdx = 51;
	  section.data(12).dtTransOffset = 11;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AIPEnter
	  section.data(13).logicalSrcIdx = 52;
	  section.data(13).dtTransOffset = 12;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AOPStart
	  section.data(14).logicalSrcIdx = 53;
	  section.data(14).dtTransOffset = 13;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AOPEnter
	  section.data(15).logicalSrcIdx = 54;
	  section.data(15).dtTransOffset = 14;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AOStart
	  section.data(16).logicalSrcIdx = 55;
	  section.data(16).dtTransOffset = 15;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AOEnter
	  section.data(17).logicalSrcIdx = 56;
	  section.data(17).dtTransOffset = 16;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_AOReset
	  section.data(18).logicalSrcIdx = 57;
	  section.data(18).dtTransOffset = 17;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOPStart
	  section.data(19).logicalSrcIdx = 58;
	  section.data(19).dtTransOffset = 18;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOPEnter
	  section.data(20).logicalSrcIdx = 59;
	  section.data(20).dtTransOffset = 19;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOStart
	  section.data(21).logicalSrcIdx = 60;
	  section.data(21).dtTransOffset = 20;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOEnter
	  section.data(22).logicalSrcIdx = 61;
	  section.data(22).dtTransOffset = 21;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOReset
	  section.data(23).logicalSrcIdx = 62;
	  section.data(23).dtTransOffset = 22;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_EIPStart
	  section.data(24).logicalSrcIdx = 63;
	  section.data(24).dtTransOffset = 23;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_EIPEnter
	  section.data(25).logicalSrcIdx = 64;
	  section.data(25).dtTransOffset = 24;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_EIStart
	  section.data(26).logicalSrcIdx = 65;
	  section.data(26).dtTransOffset = 25;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_EIEnter
	  section.data(27).logicalSrcIdx = 66;
	  section.data(27).dtTransOffset = 26;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POPStart
	  section.data(28).logicalSrcIdx = 67;
	  section.data(28).dtTransOffset = 27;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POPEnter
	  section.data(29).logicalSrcIdx = 68;
	  section.data(29).dtTransOffset = 28;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POStart
	  section.data(30).logicalSrcIdx = 69;
	  section.data(30).dtTransOffset = 29;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POEnter
	  section.data(31).logicalSrcIdx = 70;
	  section.data(31).dtTransOffset = 30;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_POReset
	  section.data(32).logicalSrcIdx = 71;
	  section.data(32).dtTransOffset = 31;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_OOReset
	  section.data(33).logicalSrcIdx = 72;
	  section.data(33).dtTransOffset = 32;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOFinal
	  section.data(34).logicalSrcIdx = 73;
	  section.data(34).dtTransOffset = 33;
	
	  ;% Joint_QuarcBlock_P.HILInitialize_DOInitial
	  section.data(35).logicalSrcIdx = 74;
	  section.data(35).dtTransOffset = 34;
	
	  ;% Joint_QuarcBlock_P.HILReadEncoder_Active
	  section.data(36).logicalSrcIdx = 75;
	  section.data(36).dtTransOffset = 35;
	
	  ;% Joint_QuarcBlock_P.HILReadAnalog_Active
	  section.data(37).logicalSrcIdx = 76;
	  section.data(37).dtTransOffset = 36;
	
	  ;% Joint_QuarcBlock_P.HILReadEncoder1_Active
	  section.data(38).logicalSrcIdx = 77;
	  section.data(38).dtTransOffset = 37;
	
	  ;% Joint_QuarcBlock_P.HILWrite_Active
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% Joint_QuarcBlock_B.SumofElements
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (Joint_QuarcBlock_DW)
    ;%
      section.nData     = 9;
      section.data(9)  = dumData; %prealloc
      
	  ;% Joint_QuarcBlock_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Joint_QuarcBlock_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 2;
	
	  ;% Joint_QuarcBlock_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 4;
	
	  ;% Joint_QuarcBlock_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 6;
	
	  ;% Joint_QuarcBlock_DW.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 8;
	
	  ;% Joint_QuarcBlock_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  ...
	  ;% Joint_QuarcBlock_DW.HILReadAnalog_PWORK
	  section.data(2).logicalSrcIdx = 11;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Joint_QuarcBlock_DW.HILReadEncoder1_PWORK
	  section.data(3).logicalSrcIdx = 12;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Joint_QuarcBlock_DW.HILWrite_PWORK
	  section.data(4).logicalSrcIdx = 13;
	  section.data(4).dtTransOffset = 3;
	
	  ;% Joint_QuarcBlock_DW.Alpha_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 14;
	  section.data(5).dtTransOffset = 4;
	
	  ;% Joint_QuarcBlock_DW.Theta_PWORK.LoggedData
