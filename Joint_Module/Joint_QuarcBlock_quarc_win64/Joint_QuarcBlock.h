...
#ifndef RTW_HEADER_Joint_QuarcBlock_h_
#define RTW_HEADER_Joint_QuarcBlock_h_
#include <math.h>
#include <string.h>
#ifndef Joint_QuarcBlock_COMMON_INCLUDES_
# define Joint_QuarcBlock_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Joint_QuarcBlock_COMMON_INCLUDES_ */

#include "Joint_QuarcBlock_types.h"
...
#define Joint_QuarcBlock_rtModel       RT_MODEL_Joint_QuarcBlock_T
...
#define rtB                            Joint_QuarcBlock_B
#define BlockIO                        B_Joint_QuarcBlock_T
#define rtP                            Joint_QuarcBlock_P
#define Parameters                     P_Joint_QuarcBlock_T
#define rtDWork                        Joint_QuarcBlock_DW
#define D_Work                         DW_Joint_QuarcBlock_T
#define ConstParam                     ConstP_Joint_QuarcBlock_T
#define rtcP                           Joint_QuarcBlock_ConstP

/* Parameters (default storage) */
struct P_Joint_QuarcBlock_T_ {
  real_T A;                            /* Variable: A
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T T;                            /* Variable: T
  ...
  real_T TachDir_Gain;                 /* Expression: -1
                                        ...
                                        */
  real_T ServoCountstoRad1_Gain;       /* Expression: 2*pi/2^12
...
struct tag_RTM_Joint_QuarcBlock_T {
  const char_T *path;
...
extern P_Joint_QuarcBlock_T Joint_QuarcBlock_P;

/* Block signals (default storage) */
extern B_Joint_QuarcBlock_T Joint_QuarcBlock_B;

/* Block states (default storage) */
extern DW_Joint_QuarcBlock_T Joint_QuarcBlock_DW;

/* Constant parameters (default storage) */
extern const ConstP_Joint_QuarcBlock_T Joint_QuarcBlock_ConstP;

/* Model entry point functions */
extern void Joint_QuarcBlock_initialize(void);
extern void Joint_QuarcBlock_output(void);
extern void Joint_QuarcBlock_update(void);
extern void Joint_QuarcBlock_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Joint_QuarcBlock_rtModel *Joint_QuarcBlock(void);
...
extern RT_MODEL_Joint_QuarcBlock_T *const Joint_QuarcBlock_M;
 ...
 *
 * '<Root>' : 'Joint_QuarcBlock'
 * '<S1>'   : 'Joint_QuarcBlock/Motor'
 */
#endif                                 /* RTW_HEADER_Joint_QuarcBlock_h_ */
