...
#endif                                 /* State_Space_Quarc_COMMON_INCLUDES_ */

#include "State_Space_Quarc_types.h"
...
#define State_Space_Quarc_rtModel      RT_MODEL_State_Space_Quarc_T
...
typedef struct {
  ...
  real_T DeadZone[2];                  /* '<Root>/Dead Zone' */
} B_State_Space_Quarc_T;
...
} DW_State_Space_Quarc_T;

/* Backward compatible GRT Identifiers */
#define rtB                            State_Space_Quarc_B
#define BlockIO                        B_State_Space_Quarc_T
#define rtP                            State_Space_Quarc_P
#define Parameters                     P_State_Space_Quarc_T
#define rtDWork                        State_Space_Quarc_DW
#define D_Work                         DW_State_Space_Quarc_T

/* Parameters (default storage) */
struct P_State_Space_Quarc_T_ {
...
struct tag_RTM_State_Space_Quarc_T {
  const char_T *path;
...
extern P_State_Space_Quarc_T State_Space_Quarc_P;

/* Block signals (default storage) */
extern B_State_Space_Quarc_T State_Space_Quarc_B;

/* Block states (default storage) */
extern DW_State_Space_Quarc_T State_Space_Quarc_DW;

/* Model entry point functions */
extern void State_Space_Quarc_initialize(void);
extern void State_Space_Quarc_output(void);
extern void State_Space_Quarc_update(void);
extern void State_Space_Quarc_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern State_Space_Quarc_rtModel *State_Space_Quarc(void);
...
extern RT_MODEL_State_Space_Quarc_T *const State_Space_Quarc_M;
 ...
 *
 * '<Root>' : 'State_Space_Quarc'
 * '<S1>'   : 'State_Space_Quarc/Motor'
 */
#endif                                 /* RTW_HEADER_State_Space_Quarc_h_ */
